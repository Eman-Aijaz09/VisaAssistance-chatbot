...
from browser_for_extraction import BrowserManager
...
provides at least one meaningful fact about it, extract that entity with
the available facts and leave all unsupported fields null or empty.

DO NOT extract "country" or "source_url" — these are already known and will be
filled in separately. Leave them out of your output entirely.
...
If this entity doesn't clearly correspond to one specific named visa,
leave "visa_key" null.
